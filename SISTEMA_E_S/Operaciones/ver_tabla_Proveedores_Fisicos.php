...
$query_usuario1= "SELECT *FROM tbl_proveedores_fisicos ORDER BY Id_Proveedor";
...
<div class="card mb-4">
  <div class="card-header">
    <center>
    <h5>CONSULTA DE PROVEEDORES FISICOS REGISTRADOS</h5>
    <button type="button" class="btn btn-success" data-toggle="modal" data-target="#registrar_proveedor"
                          aria-haspopup="true" aria-expanded="false" id="alta_pr">NUEVO</button>
    </center>
  </div>
  <div class="card-body">
    <!-- <div >
  ...
  <table class="table table-responsive-sm  table-striped" id="tabla" width="100%" cellspacing="0">
    <thead id="encabezado_tabla">
      ...
      <th id="encabezado_tabla">NOMBRE(S)</th>
        ...
        <th id="encabezado_tabla" style="visibility: hidden; display: none;">Rfc</th>
  ...
  <tbody class="cuerpo_table">
    <?php do {       ?> 
      ...
      <td id="nombre1<?php echo $row_usuario1['Id_Proveedor']; ?>"><?php echo $row_usuario1['Nombre']; ?></td>
        <td id="apellido_paterno1<?php echo $row_usuario1['Id_Proveedor']; ?>"><?php echo $row_usuario1['Apellido_Paterno']; ?></td>
        <td id="apellido_materno1<?php echo $row_usuario1['Id_Proveedor']; ?>" align="center" style="visibility: hidden; display: none;"><?php echo $row_usuario1['Apellido_Materno']; ?></td>
        <td id="curp<?php echo $row_usuario1['Id_Proveedor']; ?>" style="visibility: hidden; display: none;"><?php echo $row_usuario1['CURP']; ?></td>
        ...
        <td id="Licencia<?php echo $row_usuario1['Id_Proveedor']; ?>" align="center" style="visibility: hidden; display: none;"><?php echo $row_usuario1['RFC']; ?></td>
        <td id="sexo<?php echo $row_usuario1['Id_Proveedor']; ?>" align="center" style="visibility: hidden; display: none;"><?php echo $row_usuario1['Sexo']; ?></td>
        <td id="estado<?php echo $row_usuario1['Id_Proveedor']; ?>" align="center" style="visibility: hidden; display: none;"><?php echo $row_usuario1['Estado_civil']; ?></td>
        <td id="fecha<?php echo $row_usuario1['Id_Proveedor']; ?>" align="center" style="visibility: hidden; display: none;"><?php echo $row_usuario1['Fecha_Reg']; ?></td>
        <td id="estudios<?php echo $row_usuario1['Id_Proveedor']; ?>" align="center" style="visibility: hidden; display: none;"><?php echo $row_usuario1['Estudios']; ?></td>
        ...
        <td id="num_int<?php echo $row_usuario1['Id_Proveedor']; ?>" align="center" style="visibility: hidden; display: none;"><?php echo $row_usuario1['Num_int']; ?></td>
        <td id="num_ext<?php echo $row_usuario1['Id_Proveedor']; ?>" align="center" style="visibility: hidden; display: none;"><?php echo $row_usuario1['Num_ext']; ?></td>
        ...
        <td id="cp2<?php echo $row_usuario1['Id_Proveedor']; ?>" align="center" ><?php echo $row_usuario1['CP']; ?></td>
        ...
        <td id="Tipo<?php echo $row_usuario1['Id_Proveedor']; ?>" align="center" style="visibility: hidden; display: none;"><?php echo $row_usuario1['Tipo']; ?></td>
          ...
          <td class="opciones">
          <a type="button" title="Generar Reporte PDF" class="btn btn-info btn-sm fun boton" href="../pdf_proveedor/reporteGeneral.php?Id_Proveedor=<?php echo $row_usuario1['Id_Proveedor']; ?>">
          <span class="far fa-file-pdf"></span>
              </a>
            <button type="button" class="btn btn-success btn-sm fun boton" title="Actualizar Informacion" value="<?php echo $row_usuario1['Id_Proveedor']; ?>" id="boton5">
            <span class="fas fa-edit"></span>
            </button>
            <button type="button" class="btn btn-danger btn-sm fun boton" title="Eliminar Proveedor"  value="<?php echo $row_usuario1['Id_Proveedor']; ?>" id="boton_eliminar5">
