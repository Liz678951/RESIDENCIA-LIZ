...
$objWorksheet = $objPHPExcel->getActiveSheet()->setCellValue('G3', 'PROVEEDORES FISICOS DEL BAMX');
...
$estiloTituloReporte = array(
	...
	while($rows = $resultado->fetch_assoc()){
		...
		$objPHPExcel->getActiveSheet()->setCellValue('G'.$fila, $rows['RFC']);
...
// $objWriter->save(str_replace('.php', '.xlsx', __FILE__));
	...
	header('Content-Disposition: attachment;filename="Proveedores_Fisicos.xlsx"');
