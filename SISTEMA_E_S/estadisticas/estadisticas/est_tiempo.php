...
<div class="row">
<div class="col-md-12">
<h5  align="center" >ESTADÍSTICA POR LAPSO DE TIEMPO DE ENTRADAS Y SALIDAS DE PROVEEDORES</h5 >
</div>
</div>
</div>
		...
		$query = 'SELECT Accion, COUNT(*) as total FROM tbl_entradas_salida_proveedores WHERE Fecha_Hora  Between '. "'". $fecha. "'". ' AND '.  "'". $fecha2. "'".  ' GROUP BY '. 'Accion';
