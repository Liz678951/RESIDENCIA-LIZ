...
<div class="row">
<div class="col-md-12">
<h5  align="center" >ESTADÍSTICA DE ENTRADAS Y SALIDAS DE PROVEEDORES</h5 >
</div>
</div>
</div> -->

			<table lass="table table-responsive  table-striped">
			<thead>
				<tr>
			...
			$query = 'SELECT s.Tipo_Accion, COUNT(e.Accion) as total FROM tbl_entradas_salida_proveedores e, tbl_Accion s WHERE e.Accion = s.Tipo_Accion GROUP BY e.Accion'; 
		...
		$(function () {
			...
			var chart = $('#grafica').highcharts({
				...
				title: {
					text: 'ESTADÍSTICA DE ENTRADAS Y SALIDAS'
				},
				subtitle: {
            text: 'PROVEEDORES'
        },
	...
	<button class="btn btn-info" id="inverted">INVERTIR</button>
	</div> <br>
	<div class="container">
	<div class="row">
	<div class="col-md-12">
	...
	<form  action="javascript:()" id="tiemp" name="tiemp"  method="post" enctype="multipart/form-data"><br>
	LAPSO INICIAL: <input class="form-control"  type="datetime-local" name="De" id="De"><br>
	LAPSO FINAL: <input class="form-control"  type="datetime-local" name="A" id="A"><br>
	<div style="display:flex; justify-content: center;" class="col-md-12">
	<button class="btn btn-success" id="tiempo" type="submit">CONSULTAR<span class="fas fa-calendar"></span></button>
	</div>
	</form>
	</div>
	</div>
